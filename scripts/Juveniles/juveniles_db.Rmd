...
El objetivo C.1) se centra en determinar la diversidad y abundancia de especies leñosas que existen en el banco de árboles jóvenes, tanto dentro de los Es biogénicos creados por los bosques de enebros, robles y pinos como fuera de ellos, en la matriz ambiental.

# Hipótesis:

Nuestra hipótesis es que los Es biogénicos deberían tener un conjunto de reclutas más abundante y diversos que los espacios abiertos que los rodean, ya que la lluvia de semillas es mayor dentro de los Es y las plántulas sobreviven mejor en su microambiente. Cuanto mayor sea la diversidad de especies que componen el banco de reclutamiento, más probable será que contengan especies con diferentes rasgos funcionales y fenologías, lo que permite la complementariedad de nichos en el uso de los recursos y un período de crecimiento más largo de la comunidad de árboles jóvenes. 
...
Se ha determinado la abundancia y diversidad de especies leñosas o juveniles, en cada una de las verbatim_microstationes que componen nuestras plots de estudio. 
...
Este seguimiento, se ha realizado una sola vez en cada microestación, en los meses de junio, julio, octubre y noviembre de 2024, y también en el mes de julio de 2025, para las verbatim_microstationes que faltaban del año anterior.

# Análisis de datos: 

Se realizó un análisis exploratorio mediante diagramas de caja y bigotes para comparar el número de individuos cada 100m2 entre treatments (C vs. E), estratificado por ecosystem, orientación y altitude altitudinal. Los diagramas muestran la mediana (línea central), el rango intercuartílico (caja), la dispersión total (bigotes) y valores atípicos (puntos individuales), complementados con la media aritmética (punto rojo).
...
## ANEXO 1: Especie de juveniles y número de individuos según treatment y plot
...
Analizando los resultados obtenidos, podemos afirmar que en la cara North, hay más especies (12) que en la cara South (9). Por otro lado, observamos que la distribución de la diversidad de especies se representa de manera desigual: 10 especies en C (con 112 individuos) y 10 en E (con 118 individuos) en la cara North (de las 12 totales) y 8 en C (con 200 individuos) y 6 en E (con 288 individuos) en la cara South (de las 9 totales para esta orientación). 

De este modo, se observa que hay una mayor cantidad de individuos en la cara South (488) respecto a la cara North (230). 

Así concluimos que la diversidad es similar entre treatments para la cara North, aunque el número de individuos es mayor en el E, mientras que existe una mayor diversidad en la matriz ambiental de la cara South, aunque con un mayor número de individuos en el E de esta orientación, al igual que sucede en la cara North.

Se cumple la hipótesis de que hay mayor número de individuos bajo los Es biogénicos, mientras que la diversidad no cumple dicha premisa en la cara North al estar igualado el número de especies, a la vez que se contradice en la cara South, al ser superior el número de especies presentes en la matriz ambiental respecto al E biogénico.
